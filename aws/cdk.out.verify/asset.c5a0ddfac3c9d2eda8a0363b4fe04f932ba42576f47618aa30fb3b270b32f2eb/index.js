...
// lambda/handlers/caregiver-onboarding/index.ts
var index_exports = {};
...
async function handler(event) {
  try {
    ...
    const nextRoles = isCaregiverFirst ? ["caregiver"] : Array.from(/* @__PURE__ */ new Set([...currentRoles, "owner", "caregiver"]));
    ...
    return ok(await normalizeProfileWithStatus(result.Attributes ?? {}));
  } catch (err) {
